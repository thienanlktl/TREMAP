/**
 * Pure Simpson Hanger Selector reference helpers — NO Node `fs`/`path`.
 *
 * Operate on an already-loaded hanger-selector-reference.json object. The Node
 * build reads that file via scripts/hs-reference.js (loadHsReference); the browser
 * fetches it. Keep this module Node-builtin-free so it bundles for the browser.
 */
